/*
  Created by Accident on 2017/4/9.
 */
...
public class CustomizeSpiderWebPlot extends SpiderWebPlot {
     ...
     */
    public CustomizeSpiderWebPlot(CategoryDataset createCategoryDataset){
     ...
     * @param maxValue
     */
    public CustomizeSpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue){
        this(createCategoryDataset, maxValue, DEFAULT_DRAW_RING); //设置画环默认值
    }
     ...
     * @param drawRing
     */
    public CustomizeSpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing){
     ...
     * @param drawRing
     */
    public CustomizeSpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing, int ticks){
     ...
     * @param drawRing
     */
    public CustomizeSpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing, int ticks, String labelPrefix){
        this(createCategoryDataset, maxValue, drawRing, ticks, labelPrefix, "");
    }
     ...
     * @param drawRing
     */
    public CustomizeSpiderWebPlot(CategoryDataset createCategoryDataset, double maxValue, boolean drawRing, int ticks, String labelPrefix, String labelSuffix){
        super(createCategoryDataset);
        this.setMaxValue(maxValue);//设置坐标最大值
        this.setDrawRing(drawRing);//设置画换
        this.setTicks(ticks);//设置刻度数
        this.setLabelPrefix(labelPrefix);//刻度前缀
        this.setLabelSuffix(labelSuffix);//刻度后缀
    }
...
//添加刻度的前缀和后缀
                if(null != this.getLabelPrefix() && !"".equals(this.getLabelPrefix())){
                    label = this.getLabelPrefix() + label;
                }
                if(null != this.getLabelSuffix() && !"".equals(this.getLabelSuffix())){
                    label = label + this.getLabelSuffix();
                }
